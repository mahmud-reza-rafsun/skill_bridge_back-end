        ...
        sendVerificationEmail: async ({ user, url, token }, request) => {
            try {
                ...
                await transporter.sendMail({
                    ...
                    text: "we wish for your bright future",
                    html: `
                        <!DOCTYPE html>
                        <html lang="en">
                        <head>
                            ...
                            <style>
                                ...
                                .container { max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 10px; padding: 30px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); }
                                h1 { color: #333333; text-align: center; }
                                p { font-size: 16px; color: #555555; line-height: 1.5; }
                                .button { display: block; width: 200px; margin: 30px auto; padding: 15px 0; text-align: center; background-color: #0070f3; color: #ffffff !important; text-decoration: none; border-radius: 5px; font-weight: bold; }
